	...
	<div class="navbar_mobile">
		<details value='test'>
			...
			<ul>
				...
				<li><a href="indexLayout3.php?page=about" class="a"><strong>Over
							Dynamiek ateliers</strong></a></li>
				<li><a href="indexLayout3.php?page=product" class="a"><strong>Accesoires
	...
	<div class="navbar">
		<ul class="navbar_list">
			<li class="navbar_item_home"
				...
				href="indexLayout3.php?page=home" class="a"><strong>Home</strong></a></li>
			<li class="navbar_item_about"
				<?php if($page=='about'){echo 'style="box-shadow: inset 0 0 10px 1px rgba(0,0,0,.3);"';}?>><a
				href="indexLayout3.php?page=about" class="a"><strong>Over Dynamiek
			...
			<li class="navbar_item_product"
				...
				href="indexLayout3.php?page=product" class="a"><strong>Accesoires en
			...
			<li class="navbar_item_workshops"
				...
				href="indexLayout3.php?page=workshops" class="a"><strong>Workshops</strong></a></li>
