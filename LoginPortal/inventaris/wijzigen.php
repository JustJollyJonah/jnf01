...
<input type="submit" value="klik hier om terug te gaan" name="toevoegen">
					...
					print 	('<form action="wijzigen.php" method="post">
<input type="submit" value="klik hier om terug te gaan" name="toevoegen">
</form>') ;
				}
			...
			<table>
				...
				<?php 
				if ($actief == 1) {
					print ('<tr><td>Actief:</td><td><input type="radio" name="actief" value="1" checked> Ja<input type="radio" name="actief" value="0"> Nee </td></tr>');
				} else {
					print ('<tr><td>Actief:</td><td><input type="radio" name="actief" value="1"> Ja<input type="radio" name="actief" value="0" checked> Nee </td></tr>');
				}
				?>
