...
<body>
	...
	<table>
		<form action="inventaris.php" method="post"
			...
			<tr>
				<td>Productnaam:</td>
				<td><input type="text" value="Naam van product" name="name"></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2"><textarea rows="3" cols="50" name="beschrijving"></textarea>
				</td>
			</tr>
			<tr>
				<td>Aantal:</td>
				<td><input type="text" name="aantal" value="voer aantal in"></td>
			</tr>
			<tr>
				<td>Actief:</td>
			...
			<tr>
				<td>Webshop url</td>
				<td><input type="text" name="webshopurl" value="voer webshop url in"></td>
			</tr>
			<tr>
				...
				if (! isset ( $_POST ['toevoegen'] )) {
					...
					for($i = 1; $i < $aantalProducten; $i ++) {
						...
						while ( $row = $query->fetch () ) {
							...
							?>
    	<form action="inventaris.php" method="post">
		<input type="hidden" value="<?php print ($productnummer);?>"
			name="productnummer"> <input type="submit" value="plus" name="plus">
		<input type="submit" value="min" name="min"> <input type="submit"
			value="Verwijder" name="verwijder">
	</form>
    	<?php
						}
					}
